    ...
    <section class="text-gray-600 body-font">
        <div>
            <div class="mx-auto mt-8 lg:w-120 p-8 border border-gray-300">
                <h5 class="mb-8 text-center font-bold">
                    ようこそ、{{ $_SESSION['customer']['family_name'] . $_SESSION['customer']['first_name'] }}さん</h5>
                {{-- <form action="/login/confirm" method="post" class="mx-auto">
                    <div class="flex items-center mb-6">
                        <label for="email" class="w-1/3">メールアドレス</label>
                        <input type="email" name="email" id="email" class="w-2/3 h-8 px-2 border border-gray-500">
                    </div>
