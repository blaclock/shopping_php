<div class="text-gray-600 body-font">
    <header class="h-[80px] container mx-auto flex flex-wrap px-5 flex-col md:flex-row items-center relative">
        <a href="/products"
            class="flex title-font font-medium items-center text-gray-900   mb-4 md:mb-0 hover:opacity-80">
            ...
            <span class="ml-3 text-3xl font-midium">日本酒専門ECサイト</span>
        </a>
        <nav class="ml-auto h-full header-nav">
        ...
        {{-- <nav class="ml-auto header-nav">
            <ul class="flex menu-group">
                <li class="nav-menu menu1 hover:opacity-50 px-4 py-4">商品</li>
                <li class="nav-menu menu2 hover:opacity-50 px-4 py-4">商品2</li>
                <li class="nav-menu menu3 hover:opacity-50 px-4 py-4">商品3</li>
            </ul>
            <div class="relative drop-down-group">
                <div class="absolute drop-down menu-1 hidden">
                    <span>野菜</span>
                    <span>果物</span>
                    <span>飲料</span>
                </div>
        ...
        <div class="md:ml-auto flex flex-wrap items-center justify-center">
            ...
            <a href="/cart" class="mr-5 hover:text-gray-900">
            ...
            <a href="/login" class="mr-5 hover:text-gray-900">
...
{{-- <div>
    <ul class="flex justify-around">
        <a href="/products?category_id=1"
            class="bg-gray-100 hover:bg-gray-200 hover:opacity-80 w-1/3 py-4 text-center border border-r-white">野菜</a>
        <a href="/products?category_id=2"
            class="bg-gray-100 hover:bg-gray-200 hover:opacity-80 w-1/3 py-4 text-center border border-r-white">果物</a>
        <a href="/products?category_id=3"
            class="bg-gray-100 hover:bg-gray-200 hover:opacity-80 w-1/3 py-4 text-center border border-r-white">飲料</a>
