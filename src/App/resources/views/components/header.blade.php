<div class="text-gray-600 body-font">
    ...
    @if ($user === 'customer')
        <header
            class="h-[60px] md:h-[80px] mx-auto flex flex-wrap px-10 fixed z-50 left-0 bottom-0 md:top-0 w-full text-{{ $headerTextColorSp }} md:text-gray-600 bg-{{ $headerBgColorSp }} md:bg-{{ $headerBgColor }}">
            <a href="/products" class="hidden md:flex title-font font-medium items-center text-gray-900 hover:opacity-80">
            @else
                <header
                    class="h-[60px] md:h-[80px] mx-auto flex flex-wrap px-10 md:top-0 w-full text-{{ $headerTextColorSp }} md:text-gray-600 bg-{{ $headerBgColorSp }} md:bg-{{ $headerBgColor }}">
                    <a href="/products"
                        class="hidden md:flex title-font font-medium items-center text-gray-900 hover:opacity-80">
    @endif
    {{-- <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-linecap="round"
                stroke-linejoin="round" stroke-width="2" class="w-10 h-10 text-white p-2 bg-blue-500 rounded-full"
                viewBox="0 0 24 24">
    ...
    <span class="text-4xl font-midium text-{{ $headerTextColor }}">醸-KAMOSU</span>
    </a>
    ...
    @if ($user === 'customer')
        ...
        <div class="flex md:hidden md:ml-auto flex-wrap items-center justify-center">
            {{-- 検索欄 --}}
            <form role="search" action="/products" method="GET" class="relative mr-5 mb-0">
                {{-- <input type="hidden" name="serchUrl" value="/products/search"> --}}
                <input type="search" name="q" placeholder="商品を検索する"
