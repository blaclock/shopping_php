    ...
    <nav aria-label="Page navigation example">
        <ul class="flex list-style-none">
            ...
            <li class="page-item active">
                <a
                    class="page-link relative block py-1.5 px-3 rounded border-0 bg-gray-600 outline-none transition-all duration-300 text-white hover:text-white shadow-md focus:shadow-md">{{ $pagination['present'] }}<span
