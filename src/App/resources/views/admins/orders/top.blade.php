...
@section('content')
    <section class="text-gray-600 body-font min-h-screen">
        <h2 class="text-2xl font-bold">注文履歴管理</h2>
        ...
        <div class="flex flex-wrap m-4">
            ...
            {{-- <a href="{{ App\consts\CommonConst::APP_URL }}admin/csv_import?data=orders"
                class="lg:w-1/4 md:w-1/2 p-6 w-full border border-gray-300 duration-200 bg-white hover:bg-gray-700 hover:text-white mr-5 [&:nth-child(3n)]:mr-0 [&:nth-child(n-3)]:mt-10">
                <span>CSVインポート</span>
            </a> --}}
            <a href="{{ App\consts\CommonConst::APP_URL }}admin/csv_export?data=orders"
                class="lg:w-1/4 md:w-1/2 p-6 w-full border border-gray-300 duration-200 bg-white hover:bg-gray-700 hover:text-white mr-5 [&:nth-child(3n)]:mr-0 [&:nth-child(n-3)]:mt-10">
                <span>CSVエクスポート</span>
            </a>
        </div>
